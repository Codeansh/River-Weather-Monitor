...
var retrieveDefaultValuesFromLocalStorage = function () {
    try {
        var api_key = "D9pyvF3YVVlKMo6UBPrS";
        var model = "garbage-classification-qmp4x";
...
var getSettingsFromForm = function (cb) {
    ...
    var parts = [
        ...
        "garbage-classification-qmp4x",
        "/",
        11,
        "?api_key=D9pyvF3YVVlKMo6UBPrS"
    ];
...
var resizeImage = function (base64Str) {
    return new Promise(function (resolve, reject) {
        ...
        img.onload = function () {
            ...
            resolve(canvas.toDataURL('image/jpeg', 6.0));
        };
